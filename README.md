...
```
cd existing_repo
git remote add origin https://gitlab.com/grupo-153/citasmedicas.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/grupo-153/citasmedicas/-/settings/integrations)
